...
Não presuma o caminho: a base é um repositório git próprio, com outro dono e outro remote,
e não vem pelo `Sincronizar.bat`. Se o script falhar, ele imprime o comando de clone — não
improvise resposta de memória enquanto isso.
...
| Frase | Vai para |
|---|---|
| `preciso resolver o chamado <n>`, `faça o merge`, `vou testar`, `commit final` | `redsis-chamado` |
...
| `atualize a base de conhecimento` | `redsis-escriba` |
